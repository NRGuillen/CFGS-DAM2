...
public class mainEjercicio {
	...
	public static void añadirDirectivo(Scanner scanner) {
		...
		direct.setApellido(apellidosDirectivom);
	...
	public static void añadirProfesor(Scanner scanner, ArrayList<Profesor> profesores) {
		...
		prof.setApellido(apellidosProf);
	...
	public static void ordenarListaSueldoProfesores(Scanner scanner, ArrayList<Profesor> profesores) {

		System.out.println("Lista sin ordenar:");
		for (Profesor profesor : profesores) {
			System.out.println("   Profesor: " + profesor.getNombre() + " Sueldo: " + profesor.getSalario());
		}
		...
		System.out.println("\nEl profesor que mas cobra es: " +profesores.get(0).getNombre() +" Con un sueldo de: "+ profesores.get(0).getSalario());
	...
	public static void main(String[] args) {
		...
		Profesor profesor = new Profesor("123432W", "Juan", "Domingez sales", 1130.42, 2, true);
		Profesor profesor2 = new Profesor("123432W", "Ruben", "Domingez sales", 1230.42, 2, true);
		profesores.add(profesor);
		profesores.add(profesor2);

		Directivo directivo = new Directivo("1235438A", "Alberto", "Escobar si", 3221.2, true, Turno.MAÑANA);
		Directivo directivo2 = new Directivo("1235438A", "Alberto", "Escobar si", 3421.2, true, Turno.MAÑANA);

		Administracion admin = new Administracion("38237A", "Juan", "Guillen almodo", 31412.1, "Ingeniero informatico",
				7);
		...
		do {
			...
			System.out.println("6. Ordenar listas por sueldo");
			...
			case 6:
				...
				ordenarListaSueldoProfesores(scanner, profesores);
