...
public class EjemploInterfazVentana {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 808, 538);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);
		
		JLabel lblNewLabel = new JLabel("Boton con el enable activado");
		lblNewLabel.setBounds(235, 178, 138, 14);
		...
		JLabel lblNewLabel_1 = new JLabel("Boton con el enable desactivado");
		lblNewLabel_1.setBounds(218, 201, 155, 14);
